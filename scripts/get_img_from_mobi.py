...
def main():
    # 解析命令行参数
    parser = argparse.ArgumentParser(description="从MOBI文件中提取图片")
    parser.add_argument("mobi_file", help="MOBI文件路径")
    parser.add_argument("-o", "--output", help="图片输出目录", default="./mobi_images")
    
    args = parser.parse_args()
    
    # 执行图片提取
    success = extract_images_from_mobi(args.mobi_file, args.output)
